...
namespace margelo::nitro::dngdecoder {
  ...
  /**
   * A struct which can be represented as a JavaScript object (LinearRgb).
   */
  ...
  public:
    LinearRgb() = default;
    explicit LinearRgb(double r, double g, double b): r(r), g(g), b(b) {}

  public:
    friend bool operator==(const LinearRgb& lhs, const LinearRgb& rhs) = default;
  };
...
namespace margelo::nitro {
  ...
  // C++ LinearRgb <> JS LinearRgb (object)
  template <>
  struct JSIConverter<margelo::nitro::dngdecoder::LinearRgb> final {
    static inline margelo::nitro::dngdecoder::LinearRgb fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::dngdecoder::LinearRgb(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::dngdecoder::LinearRgb& arg) {
