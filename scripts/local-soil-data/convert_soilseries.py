...
# !! NOTE !! 
# This assumes the data you want exists in a database in a docker container.
# When I used this, the table with the global soil names, descriptions, and management strings, is wrb_fao90_desc. Here's what I did:
